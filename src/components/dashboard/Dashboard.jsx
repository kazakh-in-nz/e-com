...
export default function DashBoard({ dashBoardData }) {
  ...
  useEffect(() => {
    ...
    if (Object.keys(deliveryData).length === 0 && deliveryData.constructor === Object) {
      setDeliveryData(helperFunctions.getDeliveryData(dashBoardData));
    }
  }, []);
  ...
  return (
    <div className="db-wrapper">
      <div className="overView">Over View</div>
      <div className="charts">
        <BarChart barChartData={lastWeekData} lastWeek={lastWeekDays} />
        <DoughnutChart doughnutChartData={deliveryData} />
      </div>
      <div className="table">
        ...
        <DashBoardPagination
          ...
          numCustomerDisplayed={numCustomersDisplayed}
        />
      </div>
    </div>
  );
